          ...
          <form onSubmit={handleSubmit(formSubmit)}>
            ...
            {formStep >= 1 && (
              <section className={`${formStep === 1 ? "block" : "hidden"}`}>
                ...
                <label htmlFor="max_bandwidth">Max-Bandwidth</label>
                <input
                  type="number"
                  id="max_bandwidth"
                  placeholder="in mbps"
                ...
                <label htmlFor="min_bandwidth">Min-Bandwidth</label>
                <input
                  type="number"
                  id="min_bandwidth"
                  placeholder="in mbps"
                ...
                <label htmlFor="security_management">Security Management</label>
                <select
                ...
                <label htmlFor="max_storage">Max-Storage</label>
                <input
                  type="number"
                  id="max_storage"
                  placeholder="in GB"
                ...
                <label htmlFor="min_storage">Min-Storage</label>
                <input
                  type="number"
                  id="min_storage"
                  placeholder="in GB"
            ...
            {formStep >= 2 && (
              <section className={`${formStep === 2 ? "block" : "hidden"}`}>
                ...
                <label htmlFor="costperband">Cost/Bandwidth</label>
                <input
                  type="number"
                  id="costperband"
                  placeholder="in Rupee"
              ...
              <section className={`${formStep === 3 ? "block" : "hidden"}`}>
                ...
                <select
                  ...
                  {...register("memorysize", {
                    required: {
                      value: true,
                      message: "please enter memory size",
                    },
                  })}
                >
                  <option value="Veryhigh">Very High</option>
